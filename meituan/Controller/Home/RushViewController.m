...
-(void)initViews{
    ...
    NSString * videoURL=@"http://m.marykayintouch.com.cn/MiniCommunity/SeminarVideos?SeminarID=32D433E1-00B6-40BC-AE05-53EBF607BEFE&RoundID=-1&CategoryID=2&VideoID=75";
...
-(void)webViewDidStartLoad:(UIWebView *)webView{
    NSLog(@"开始加载名店抢购webview");
}

-(void)webViewDidFinishLoad:(UIWebView *)webView{
    NSLog(@"加载名店抢购webview完成");
